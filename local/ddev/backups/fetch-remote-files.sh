...
# Configuration
HOSTS="dev:library-drupal-develop-0.internal.lib.virginia.edu staging:drupal-staging-0.internal.lib.virginia.edu prod:library-drupal-0.internal.lib.virginia.edu"
DEFAULT_ENV="dev"
