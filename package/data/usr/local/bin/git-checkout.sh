...
if [ ! -d ${DOCROOT}/themes/custom/uvalib_drupal_theme_2026 ]; then
	git clone https://github.com/uvalib/uvalib_drupal_theme_2026.git ${DOCROOT}/themes/custom/uvalib_drupal_theme_2026
fi
